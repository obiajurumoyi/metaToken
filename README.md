...
This is an ERC-20 called `MetaToken` with symbol `MTK`. The Contract inherits OpenZeppelin ERC20 standard, with extra implementation to mint, burn and transfer.
